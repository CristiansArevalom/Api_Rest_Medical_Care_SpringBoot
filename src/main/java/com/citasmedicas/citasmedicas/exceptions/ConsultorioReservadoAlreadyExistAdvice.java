...
@ControllerAdvice
@ResponseBody
public class ConsultorioReservadoAlreadyExistAdvice {
        ...
        @ResponseBody
        @ExceptionHandler(ConsultorioAlreadyExistException.class)
        @ResponseStatus(HttpStatus.CONFLICT)
        String ConsultorioAdvice(ConsultorioAlreadyExistException ex){
